...
from modules.model import MODELS, LANGUAGE_NAME_TO_CODE
...
asset_store.metadata_providers.append(InProcAssetMetadataProvider(MODELS))
...
TARGET_LANGUAGE_NAMES = ["English", "French", "German", "Spanish", "Mandarin Chinese"]
...
with gr.Blocks(css="./style.css") as demo:
    ...
    gr.Examples(
        examples=[
            ...
            ["assets/Sad-English.wav", "English", "Mandarin Chinese"],
